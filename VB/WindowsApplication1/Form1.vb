...
Namespace WindowsApplication1
    ...
    Public Partial Class Form1
        ...
        Private Sub schedulerControl1_CustomDrawTimeCell(ByVal sender As Object, ByVal e As DevExpress.XtraScheduler.CustomDrawObjectEventArgs)
        ...
        Private Sub schedulerControl1_AllowAppointmentConflicts(ByVal sender As Object, ByVal e As DevExpress.XtraScheduler.AppointmentConflictEventArgs)
            ...
            Dim lunchTimeInterval As TimeInterval = New TimeInterval(e.Appointment.Start.[Date].AddHours(startLunchHour), TimeSpan.FromHours(endLunchHour - startLunchHour))
            Dim aptTimeInterval As TimeInterval = New TimeInterval(e.AppointmentClone.Start, e.AppointmentClone.[End])
            If lunchTimeInterval.IntersectsWith(aptTimeInterval) Then
                e.Conflicts.Add(e.AppointmentClone)
            End If
        End Sub

        Private msb As SolidBrush = New SolidBrush(Color.FromArgb(90, 50, 50, 50))

        Private Sub schedulerControl1_Paint(ByVal sender As Object, ByVal e As PaintEventArgs)
            ...
            If TypeOf schedulerControl1.ActiveView Is DayView Then
                For Each column As DayViewColumn In CType(schedulerControl1.ActiveView.ViewInfo, DayViewInfo).Columns
                    ...
                    If rect <> Rectangle.Empty Then
                        Using f As Font = New Font("Arial", rect.Height \ 3, GraphicsUnit.Pixel)
